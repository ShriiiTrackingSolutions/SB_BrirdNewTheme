            ...
            <nav class="mynavbar bg-light">
              <div class="container header">
                ...
                <ul class="navMenu ms-auto mb-2 mb-lg-0">
                  ...
                  <li class="navLi"><a href="#recentWork" class="navLink">Our Mission</a></li>
                  <li class="navLi"><a href="#work" class="navLink">Services</a></li>
      ...
      <div class="f-bottom effect">
        <div class="container">
          <div class="row ">
            <div class="col-12">
              <div class="inner">
                <div class="copyright text-center"> <span class="year"></span>  All Rights Reserved by SB Bird Netting Solution | Developed by <a href="https://shriiitrackingsolution.in/" target="_blank">
